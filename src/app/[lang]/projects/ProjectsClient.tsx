                ...
                <div className="flex flex-col items-center justify-center px-4 py-16 text-center">
                  ...
                  {selectedTags.length > 0 && (
                    <button
                      ...
                      className="min-h-[44px] px-4 py-2 text-xs font-medium text-accent transition-all duration-150 ease-[cubic-bezier(0.25,1,0.5,1)] hover:text-accent/80 active:scale-[0.98] active:opacity-90 touch-manipulation"
                    >
