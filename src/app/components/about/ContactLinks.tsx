      ...
      {links.map((link) => {
        ...
        return (
          <a
            ...
            className="group relative flex size-12 items-center justify-center rounded-lg border border-overlay-border bg-surface-2 transition-all duration-300 ease-[cubic-bezier(0.25,1,0.5,1)] hover:border-overlay-border-hover hover:bg-surface-4 active:scale-[0.95] active:bg-surface-4 focus:outline-none focus:ring-1 focus:ring-white/20"
          ...
          >
            ...
            <div className="absolute -bottom-0.5 -right-0.5 size-1 bg-faint transition-colors group-hover:bg-white/30" />
          </a>
        );
      })}
    </div>
