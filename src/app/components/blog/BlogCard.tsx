...
export const BlogCard = memo(({ post }: BlogCardProps) => {
  ...
  return (
    <Link
      ...
      scroll={false}
      onClick={handleClick}
      className="block px-6 py-5 sm:px-8 sm:py-6 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-inset active:scale-[0.99] active:bg-surface-2/40 transition-all duration-150"
    >
