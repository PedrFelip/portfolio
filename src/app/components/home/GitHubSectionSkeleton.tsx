...
export function GitHubSectionSkeleton() {
  return (
    <div className="relative animate-pulse">
      ...
      <div className="rail-bounded overflow-hidden">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="px-6 py-10 sm:px-8 sm:py-12">
            <div className="h-3 w-20 rounded bg-faint" />
            <div className="mt-4 h-8 w-48 rounded bg-faint sm:h-10" />
            <div className="mt-3 h-12 w-full max-w-md rounded bg-faint" />
          </div>
          ...
          <div className="flex flex-col justify-center px-6 py-10 border-t border-dashed border-border sm:border-t-0 sm:border-l sm:py-12 lg:px-10">
            <div className="flex flex-col items-start sm:items-center">
              <div className="h-12 w-24 rounded bg-faint sm:h-16" />
              <div className="mt-2 h-3 w-32 rounded bg-faint" />
            </div>
          </div>

          {/* Column 3: Decorative Grid Placeholder */}
          <div className="relative border-t border-dashed border-border lg:border-t-0 lg:border-l sm:col-span-2 lg:col-span-1 overflow-hidden min-h-[120px] sm:min-h-[160px] lg:min-h-0 bg-surface-2">
      ...
      <div className="rail-bounded border-t border-dashed border-border bg-surface-1">
        <div className="relative py-12 sm:py-16 flex justify-center">
          <div className="h-[120px] w-full max-w-4xl rounded bg-surface-2" />
        </div>
      </div>
    </div>
  );
