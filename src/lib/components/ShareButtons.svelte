...
<div class="mt-6 border-t pt-6">
	...
	<div class="group relative">
		...
		<button
			...
			class={cn(
				'relative w-full rounded-lg border bg-card p-4 text-card-foreground shadow-sm transition-all duration-300',
				'hover:shadow-md',
				'before:absolute before:inset-0 before:rounded-lg before:p-[1px] before:content-[""]',
		...
		>
			<div class="relative z-10 flex items-center justify-between">
				<div class="flex items-center gap-2">
					...
					<span class="font-medium">{$t.blog.share}</span>
				</div>
				<svg
					class={cn('h-5 w-5 transition-transform duration-300', isExpanded && 'rotate-180')}
					fill="none"
					stroke="currentColor"
					viewBox="0 0 24 24"
				>
