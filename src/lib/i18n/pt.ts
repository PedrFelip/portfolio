export const pt = {
	...
	projects: {
		...
		items: {
			...
			"notes-api": {
				title: "Notes API",
				description: "API REST simples para gerenciamento de notas construída com Node.js, Fastify e TypeScript. Recursos incluem operações CRUD, validação de dados com Zod, Prisma ORM para PostgreSQL e containerização Docker. Implementa arquitetura limpa com camadas separadas (controller, service, repository)."
			}
		}
	},
	...
	philosophy: {
		...
		text1: "Acredito que a melhor forma de crescer como desenvolvedor é através da experiência prática. Cada projeto é uma oportunidade para resolver problemas reais, experimentar novas tecnologias e expandir os limites do que eu sei.",
		text2: "Seja otimizando infraestrutura, projetando arquiteturas escaláveis ou automatizando workflows complexos — sou movido pelo desafio de construir sistemas que funcionam de forma confiável e eficiente."
	},
	...
	contact: {
		...
		description: "Interessado em colaborar em um projeto, discutir tecnologia ou apenas quer dizer oi? Estou sempre aberto a conectar com outros desenvolvedores e explorar novas oportunidades. Sinta-se à vontade para entrar em contato através de qualquer um dos meus canais sociais abaixo!"
	},
